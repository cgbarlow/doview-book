---
source_pdf: docs/pdf/b1tool.pdf
pair: b1
kind: tool
---
...
> **Pair:** [Question](b1question.md) · Tool (this page)
...
flowchart TD
    ...
    n3["Increasing use of ad hoc static diagrams and visuals at lower levels within the planning process and informally with higher-level decision makers"]
    n4["Standardized DoView strategy/outcomes diagram-based used in some parts of planning"]
    n5["DoView strategy/outcomes diagram-based planning tools used across all levels of planning, innovation, implementation, performance measurement and reporting"]
    n1 --> n2 --> n3 --> n4 --> n5
```
