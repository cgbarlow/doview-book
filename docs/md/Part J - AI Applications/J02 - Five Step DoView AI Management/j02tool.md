---
source_pdf: docs/pdf/j2tool.pdf
pair: j02
kind: tool
---
...
> **Pair:** [Question](j02question.md) · Tool (this page)
...
```mermaid
flowchart LR
    A["A — Develop (or update) the AI system's DoView strategy/outcomes diagram"]
    B["B — Ensure that the way the AI is designed is aligned with its DoView diagram"]
    C["C — Set accountabilities on the AI system's DoView and measure if it is achieving them"]
    D["D — Evaluate the AI system's success against its DoView"]
    E["E — Dashboard the AI system's results on its DoView diagram and improve its performance"]
    A --> B --> C --> D --> E --> A
```
