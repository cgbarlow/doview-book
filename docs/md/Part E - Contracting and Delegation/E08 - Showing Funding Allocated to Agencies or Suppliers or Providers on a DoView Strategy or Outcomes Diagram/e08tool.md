---
source_pdf: docs/pdf/e8tool.pdf
pair: e08
kind: tool
---
...
> **Pair:** [Question](e08question.md) · Tool (this page)
...
```mermaid
flowchart TD
    top["Maintaining, restoring and protecting ecosystems (161k)"]
    a["Full range of ecosystems is conserved in a healthy functioning state (70.4k)"]
    b["Other operational programs including providing developing tools undertaking research and evaluation (19k)"]
    c["Public conservation of lands waters and species (60.4k)"]
    d["Nationally threatened species are conserved to ensure persistence (10.8k)"]
    top --> a
    top --> b
    top --> c
    top --> d
