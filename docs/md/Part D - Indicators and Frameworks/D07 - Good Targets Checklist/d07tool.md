---
source_pdf: docs/pdf/d7tool.pdf
pair: d07
kind: tool
---
...
> **Pair:** [Question](d07question.md) · Tool (this page)
...
```mermaid
flowchart LR
    fired["Sufficient number of arrows fired from bow<br/>(005 Number of arrows fired per hour, Target = 100) @"]
    past["Arrows get past any barriers put up in the way<br/>(006 Percent arrows get past barriers, Target = 70%)"]
    next["…"]
    fired --> past --> next
```
