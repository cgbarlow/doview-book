---
source_pdf: docs/pdf/d1tool.pdf
pair: d1
kind: tool
---
...
> **Pair:** [Question](d1question.md) · Tool (this page)
...
```mermaid
flowchart TD
    subgraph SP["Strategy and planning"]
        A["A — Evidence-based STRATEGY specified"]
        B["B — PRIORITIZATION of outcomes"]
        C["C — ALIGNMENT of activities"]
    end
    subgraph MPO["Monitoring performance & outcomes"]
        D["D — OUTPUTS and indicators the initiative controls"]
        E["E — High-level OUTCOMES that are not-necessarily controllable or attributable to the initiative"]
    end
    subgraph EV["Evaluation"]
        F["F — IMPLEMENTATION evaluation for optimization"]
        G["G — PROCESS evaluation for description"]
        H["H — IMPACT evaluation to prove impact"]
        I["I — ECONOMIC and SUMMATIVE evaluation"]
    end
```
