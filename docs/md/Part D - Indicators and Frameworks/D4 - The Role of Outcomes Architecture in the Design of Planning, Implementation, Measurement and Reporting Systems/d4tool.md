---
source_pdf: docs/pdf/d4tool.pdf
pair: d4
kind: tool
---
...
> **Pair:** [Question](d4question.md) · Tool (this page)
...
```mermaid
flowchart TD
    subgraph TOP["Top level of the strategy space"]
        T1["DoView 1"]
        T2["DoView 2"]
        T3["DoView 3"]
    end
    subgraph LOWER["Where necessary, additional levels of the strategy space may need to be DoViewed"]
        L1["DoView 1"]
        L2["DoView 2"]
        L3["DoView 3"]
    end
