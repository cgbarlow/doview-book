---
source_pdf: docs/pdf/g4tool.pdf
pair: g4
kind: tool
---
...
> **Pair:** [Question](g4question.md) · Tool (this page)
...
```mermaid
flowchart LR
    P["Initiative planning and implementation"] --> R["Initiative running"] --> M["Initiative maturity / conclusion"]
```
